...
export default function Home() {
  return (
    <>
      ...
      />
      <div className="z-20 cursor-pointer"></div>
      <div className="w-full h-screen absolute top-12 -translate-y-1/2 left-0 ">
        <RenderModel>
          <HatModel />
        </RenderModel>
      </div>
      <div className="relative w-full h-screen flex flex-col items-center justify-center">
        <div className="absolute flex flex-col items-center text-center top-[70%] left-1/2 -translate-x-1/2 -translate-y-1/2">
          <h1 className="font-bold text-8xl text-accent">SimonNguyen</h1>
